...
export default defineConfig({
  ...
  resolve: {
    alias: {
      '@justforfun-ui/components': path.resolve(__dirname, '../packages/components'),
      '@justforfun-ui/theme-chalk': path.resolve(__dirname, '../packages/theme-chalk'),
      '@justforfun-ui/utils': path.resolve(__dirname, '../packages/utils'),
      '@justforfun-ui/hooks': path.resolve(__dirname, '../packages/hooks'),
      '@justforfun-ui/constants': path.resolve(__dirname, '../packages/constants'),
